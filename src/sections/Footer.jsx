...
const Footer = () => {
  return (
    <div className="flex flex-col items-center justify-center bg-[#0A0427] text-black py-12 px-4">
      {/* Hero Section */}
      <div className="bg-#A78BFA text-white w-full max-w-5xl rounded-3xl p-12 text-center relative">
      ...
      <footer className="w-full max-w-6xl mt-16 text-white flex flex-wrap justify-between items-start">
        ...
        <div className="flex flex-wrap space-x-12 mt-6 md:mt-0">
          <div>
          ...
          <div>
            ...
            <div className="flex mt-2">
              <input
                ...
                className="px-4 py-2 border border-gray-300 rounded-l-full text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
      ...
      <ul className="flex flex-1 justify-center gap-8 mt-16 md:justify-end">
